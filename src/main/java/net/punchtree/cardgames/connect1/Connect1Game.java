...
public class Connect1Game implements CardGame {
	...
	private final Connect1Display display;
	...
	public Connect1Game(Player player1, Player player2) {
		...
		display = new Connect1Display(this);
