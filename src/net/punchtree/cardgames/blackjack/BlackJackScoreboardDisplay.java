...
public class BlackJackScoreboardDisplay extends ScoreboardDisplay {	
	
	private final BlackJackGame game;
	
	public BlackJackScoreboardDisplay(BlackJackGame blackJackGame) {
		super(ChatColor.DARK_GRAY + "Black" + ChatColor.GOLD + "Jack");
