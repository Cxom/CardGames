package net.punchtree.cardgames.connect1;
...
import net.punchtree.cardgames.connect1.Connect1Game.Token;
import net.punchtree.cardgames.display.ScoreboardDisplay;

public class Connect1Display {

	private static final String GRID_COIN = "█";
	
	// For chat serialization later
	private final Connect1Game game;
	private final ScoreboardDisplay scoreboard;
	
	private final Set<Player> players = new HashSet<>();
	
	public Connect1Display(Connect1Game game) {
		this.game = game;
		
		this.scoreboard = new ScoreboardDisplay(Connect1Game.TITLE);
	}
